<template>
    ...
    <div class="jb-wrap">
    <div class="jb-image">
        <img src="https://awesome-s320221201003413196200000001.s3.ap-northeast-2.amazonaws.com/grandhotel.png" alt="">
        ...
        <div class="jb-price">
         ...
         <div  class="jb-hotelname"> {{ hotels[7].bizplc}} </div>
         <div  class="jb-addr"> {{ hotels[7].lotnoaddr}} </div>
